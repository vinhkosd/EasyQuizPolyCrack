...
`;let doc=document.head||document.documentElement;const scriptTag=document.createElement("script");scriptTag.src=chrome.runtime.getURL("injects/upload_script.js"),scriptTag.onload=()=>scriptTag.parentNode.removeChild(scriptTag),doc.appendChild(scriptTag);const scriptFshare=document.createElement("script");scriptFshare.textContent=uploadUnlimitedScript,scriptFshare.onload=()=>scriptFshare.parentNode.removeChild(scriptFshare),doc.appendChild(scriptFshare);const btnUpload=document.querySelector(".myButton");btnUpload&&(btnUpload.textContent="Tải lên Fshare (Không giới hạn dung lượng)");let note="Nếu có nhiều file sinh viên nén file để nộp. Nộp file gốc";h1=document.createElement("h1"),h1.setAttribute("style","color: blue; font-size: 1.7em; line-height: 1.5;"),h1.innerHTML=note;const il_HeaderInner=document.querySelector(".il_HeaderInner");if(il_HeaderInner&&il_HeaderInner.appendChild(h1),!document.querySelector("tbody > tr > .ilCenter")){btnUpload&&(btnUpload.style.display="none");const a=document.createElement("h3");a.setAttribute("style","color: blue;"),a.innerText="Chỉ tải lên 1 file, nếu có nhiều file vui lòng nén zip/rar để nộp. Xóa file cũ nếu muốn nộp lại",document.querySelector(".ilToolbar")?.appendChild(a)}